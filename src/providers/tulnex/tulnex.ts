...
export class TulnexProvider extends BaseProvider {
    ...
    readonly SERVERS = [
        'onion', 'vidzee', 'icefy', 'tik', 'vaplayer',
        'vidfast-alpha', 'uniquestream', 'vidfast-mega',
        'vidfast-vrapid', 'allmovies', 'vidlink',
        'vidfast-vedge', 'vidfast-vfast', 'moviebox'
    ];
    ...
    private async getSources(
        ...
        try {
            ...
            const successful = results
                .filter(
                    (r): r is PromiseFulfilledResult<Awaited<ReturnType<typeof this.doScrape>>> =>
